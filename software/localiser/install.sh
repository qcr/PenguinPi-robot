...
=======
>>>>>>> 207c1f9acf7354782eef09ef1ec5fdbe175b3a8e
...
=======
if [ $arch = "armhf" ]; then 
    echo "Building for raspberry pi with camera"
    camera=TRUE
else 
    echo "Building for image processing + web server"
    camera=FALSE
fi
...
if [ $camera = "TRUE" ]; then
    ...
    sudo cp scripts/videostream* $SCRIPT_INSTALL_DIR

else 
# Build for desktop computer
